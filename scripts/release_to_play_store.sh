...
# Kullanım: ENCRYPTION_KEY='...' ./scripts/release_to_play_store.sh
...
echo "2. Create new release → AAB yükle: build/app/outputs/bundle/release/app-release.aab"
