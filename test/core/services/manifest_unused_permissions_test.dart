...
void main() {
  group('Manifest unused FGS permissions', () {
    test('FOREGROUND_SERVICE_LOCATION must not be declared if no service uses location type', () {
      final manifestContent = File('android/app/src/main/AndroidManifest.xml')
          .readAsStringSync();

      final hasLocationFgsPermission = manifestContent
          .contains('android.permission.FOREGROUND_SERVICE_LOCATION');
      final hasLocationServiceType = manifestContent
