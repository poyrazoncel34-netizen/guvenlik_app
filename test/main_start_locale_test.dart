...
void main() {
  test(
    'main.dart sets startLocale to tr_TR so app opens in Turkish by default',
    () {
      ...
      expect(
        ...
        isTrue,
        reason:
            'EasyLocalization must have startLocale set to tr_TR to default to Turkish',
      );
    },
  );

  test('main.dart clears a non-Turkish persisted locale on startup', () {
    final source = File('lib/main.dart').readAsStringSync();
